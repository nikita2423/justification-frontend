...
const stages = [
  { id: 1, label: "Upload Products", description: "Add files for each product" },
  { id: 2, label: "Preview & Edit", description: "Review and modify data" },
  { id: 3, label: "Approval", description: "Submit for approval" },
] as const

export function ProgressStepper({ currentStage, onStageClick }: ProgressStepperProps) {
  return (
            ...
            <div key={stage.id} className="flex items-center flex-1">
              <div className="flex flex-col items-center flex-1">
                ...
                <div className="mt-3 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5 hidden sm:block">{stage.description}</p>
                </div>
              </div>
